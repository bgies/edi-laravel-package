  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 id="edi-duplicate-title" class="modal-title">EDI Type Duplicate</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
          <p class="edi-duplicate-body">Click the "Duplicate EDI Type" button to create a new EDI Type with the same properties as @ediTypeName. Only do this if you know what you are doing</p>
          <p class="edi-duplicate-body">Note - This cannot be undone.</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" onclick="cancelDuplicateType()" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-primary" onclick="duplicateType()">Duplicate EDI Type</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal" id="edi-new-modal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 id="edi-duplicate-title" class="modal-title">New EDI Type</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
...
//			tooltip.hide()
			...
			modalTitle.innerHTML = 'Duplicate ' + ediTypeName; 
